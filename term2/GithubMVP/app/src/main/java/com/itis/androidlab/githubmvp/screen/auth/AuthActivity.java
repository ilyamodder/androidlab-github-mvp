...
import com.itis.androidlab.githubmvp.screen.repositories.RepositoriesActivity;
...
public class AuthActivity extends AppCompatActivity implements AuthView {
    ...
    @BindView(R.id.loginEdit) EditText mLoginEdit;

    @BindView(R.id.passwordEdit) EditText mPasswordEdit;

    @BindView(R.id.loginInputLayout) TextInputLayout mLoginInputLayout;
